<x-layout>
    ...
    <div class="flex flex-col lg:flex-row gap-4 relative">
        {{-- DOCUMENTATION --}}
        <div class="wrapper min-h-[calc(100vh-178px)] w-full lg:w-1/2 text-black">
            ...
            <div class="flex flex-col gap-2 items-start">
                ...
                <button class="list-button button-add">Perdiksikan total penjualan tahun depan berdasarkan data masa lalu</button>
            </div>
    ...
    @push('scripts')
        <script>
            ...
            function hideLoading() {
                ...
                document.querySelectorAll('.list-button').forEach(button => button.disabled = false);
            }
            ...
            async function sendMessage(messageText = null) {
                ...
                try {
                    const response = await fetch('https://agent.adminbalibaci.my.id/chat/', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-Secret-Key': "DQm7l9NUIKoMuJ2f639wIRBEriVxnjji"
                        },
                    ...
                    addMessage('bot', data.response['output']);
                    scrollToBottom()
                } catch (error) {
